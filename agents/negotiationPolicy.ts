...
- For requireSameDoctor, use natural front-desk wording such as: "Wala pong available slot with Dr. Santos at that time. If mas important po ang schedule, we can check another available doctor. Okay lang ba iyon?" Use the supplied originalDoctorName. Never say "if you insist" or "redirect".
